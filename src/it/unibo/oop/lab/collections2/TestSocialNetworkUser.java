...
public final class TestSocialNetworkUser {
	...
	public static void main(final String... args) {
		...
		final SocialNetworkUser<User> dwashington = new SocialNetworkUserImpl<User>("Denzel", "Washington",
				"dwashington", 59);
		final SocialNetworkUser<User> mgladwell = new SocialNetworkUserImpl<User>("malcom", "Gladwell", "mgladwell",
				51);
